...
export function useAuthRedirect() {
  ...
  useEffect(() => {
    ...
    // Always navigate to dashboard to allow KiliSenseLayout to render the Welcome screen for 0 farms
    navigate("/dashboard");
...
export function resolvePostLoginPath(role: string | null | undefined): string {
  ...
  return "/dashboard"; // Farm check will happen inside KiliSenseLayout if needed
}
