...
// â”€â”€â”€ Account / system links (always visible â€” not gated by entitlement) â”€â”€â”€â”€â”€â”€
const ACCOUNT_LINKS = [
...
export function MobileMoreMenu({ open, onClose }: MobileMoreMenuProps) {
  ...
  // â”€â”€ Same entitlement / RBAC logic as desktop sidebar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Split: bottom bar gets top-N, More gets the rest â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true" aria-label="More navigation">
      ...
      {/* Bottom sheet â€” mobile-native, never the desktop sidebar */}
      <div className="absolute bottom-0 left-0 right-0 bg-background rounded-t-2xl shadow-2xl flex flex-col max-h-[85dvh]"
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 py-3 space-y-5">
          ...
          {/* â”€â”€ Dynamic module + service sections (excludes "overview" which is in the bottom bar) */}
          ...
          {/* â”€â”€ Account & System â€” always visible regardless of entitlement â”€â”€â”€ */}
          <div>
            <p className="text-[10px] font-bold uppercase tracking-wider text-muted-foreground px-1 mb-2">
              Account & System
            </p>
            <div className="flex flex-col gap-0.5">
              ...
              {/* Install App â€” only shown when PWA install is available */}
              {deferredPrompt && (
                <button
