    ...
    <Card className="border shadow-sm bg-white">
      <CardContent className="p-5">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-semibold text-slate-600">Equipment</span>
        </div>
    ...
    <Card className="border shadow-sm bg-white flex flex-col h-full">
      <div className="p-4 border-b flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-[14px] text-slate-800">Equipment Summary</span>
        </div>
      ...
      <CardContent className="p-4 flex-1 flex flex-col">
        <div className="space-y-2 mb-4">
          <div className="flex justify-between text-sm">
            <span className="text-slate-500">Total Equipment</span>
          ...
          <div className="flex justify-between text-sm">
            <span className="text-slate-500">Needs Service</span>
            <span className="font-bold text-red-500">—</span>
          </div>
        </div>
        <div className="mt-4 pt-3 border-t text-center">
          <a href="/inventory/equipment" className="text-[12px] font-bold text-cyan-600 hover:text-cyan-700">View Equipment →</a>
        </div>
      </CardContent>
    </Card>
  );
