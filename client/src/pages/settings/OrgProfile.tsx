...
export default function OrgProfile() {
  ...
  if (!organizationId) return <div className="p-4 text-muted-foreground">No active organization found.</div>;

  return (
    <div className="max-w-2xl space-y-8">
      {/* Header */}
      <div className="pb-6 border-b border-border">
        <h2 className="text-2xl font-semibold text-foreground tracking-tight">Organization Profile</h2>
      ...
      <form onSubmit={(e) => { e.preventDefault(); update.mutate({ organizationId, ...form }); }} className="space-y-8">
        {/* Logo */}
        <section>
          <h3 className="text-sm font-medium text-muted-foreground mb-4">Organization Logo</h3>
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground capitalize">{org?.businessType?.replace(/_/g, " ")} Organization</p>
        ...
        <section className="space-y-4">
          <h3 className="text-sm font-medium text-muted-foreground border-b border-border pb-3">Organization Details</h3>
          <div className="space-y-1.5">
            <Label className="text-sm font-medium text-muted-foreground">Organization Name <span className="text-red-500">*</span></Label>
        ...
        {/* Contact */}
        <section className="space-y-4">
          <h3 className="text-sm font-medium text-muted-foreground border-b border-border pb-3 flex items-center gap-2">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-1.5 max-w-xs">
            <Label className="text-sm font-medium text-muted-foreground">Tax / PIN Number <span className="text-xs text-muted-foreground font-normal">(Optional)</span></Label>
        ...
        <div className="pt-2 border-t border-border flex items-center justify-between">
          <p className="text-xs text-muted-foreground">Only the organization owner can save changes.</p>
