...
KiliSense is a comprehensive agricultural management platform built with React, Express, tRPC, and Drizzle ORM.
...
## Scheduled Jobs (Cron)
KiliSense relies on scheduled jobs for background tasks such as enforcing subscription expiries and generating reminders. In production (e.g. Render), you should set up Cron Jobs to hit the following endpoints daily:
